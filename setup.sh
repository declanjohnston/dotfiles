...
#
# Usage: 
#   ./setup.sh           # Full installation (~60-80 minutes)
#   ./setup.sh --minimal # Minimal installation for RunPod/Cursor (~5-10 minutes)
# ===================================================================
...
if [[ "$MINIMAL_INSTALL" == true ]]; then
    # MINIMAL MODE: Install only essential CLI tools
    gum_info "Installing core CLI tools (minimal mode)..."
